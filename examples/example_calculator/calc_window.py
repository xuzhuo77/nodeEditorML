...
class CalculatorWindow(NodeEditorWindow):
    ...
    def addTestNodes(self):
        # from examples.example_calculator.nodes.neighbors import SklearnKNNContent
        # node1 = SklearnKNNContent(self.nodeeditor.scene, "My Awesome Node 1", inputs=[0,0,0], outputs=[1])
        #
